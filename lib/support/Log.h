...
#ifndef TYCART_LOGGER_H
#define TYCART_LOGGER_H
...
namespace tycart::detail {
inline void do_log(const std::string& msg) {
  llvm::errs() << msg;
}
}  // namespace tycart::detail
